...
class _AnimationPageState extends State<AnimationPage> {
  ...
  double angle = 0;
  String line1 = "Love";
  String line2 = "Chúc em 8/3 luôn bình an và tươi cười thật nhiều";
    ...
    return GestureDetector(
      ...
      onTap: () {
        setState(() {
          ...
          if (selected) {
            line1 = "Love";
            line2 = "Chúc em có một ngày thật ý nghĩa và thật nhiều may mắn nhé";
          } else {
            line1 = "Love";
            line2 = "Chúc em 8/3 luôn bình an và tươi cười thật nhiều";
          }
          angle = (angle + pi) % (2 * pi);
        });
      },
